# -*- coding: utf-8 -*-
"""
Created on Thu Apr 30 12:52:40 2020
...
# Fitting logestic regression to train data set
...
plt.contourf(x1 ,x2, classifier.predict(np.array([x1.ravel(),x2.ravel()]).T).reshape(x1.shape),
                    alfa=0.75, camp=ListedColormap(("red","green")))
...
# Visualising the Testng  set result
from matplotlib.colors import ListedColormap
